...
export class Migration1757944430621 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "assignment" ("id" SERIAL NOT NULL, "driver_id" integer NOT NULL, "load_id" integer NOT NULL, "status" "public"."assignment_status" NOT NULL DEFAULT 'ASSIGNED', "assigned_at" TIMESTAMP NOT NULL DEFAULT now(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), CONSTRAINT "PK_43c2f5a3859f54cedafb270f37e" PRIMARY KEY ("id"))`);
